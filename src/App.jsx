...
const App = () =>{
    ...
    useEffect(() => {
        ...
        async function getEvolutions (id) {
            ...
            let pokemonLv1 = data.chain.species.
            name;
            let pokemonLv1Img = await getPokemonImgs
            (pokemonLv1)
            ...
            if(data.chain.evolves_to.length !== 0) {
                ...
                name;
                let pokemonLv2Img = await getPokemonImgs
                (pokemonLv2)
                ...
                !==0){
                    let pokemonLv3 = data.chain.evolves_to[0].
                    evolves_to[0].species.name;
                    let pokemonLv3Img = await getPokemonImgs
                (pokemonLv3)
                pokemonEvoArray.push([pokemonLv3,
                pokemonLv3Img])
                }
            }
